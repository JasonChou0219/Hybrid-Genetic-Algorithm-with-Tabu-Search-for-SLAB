...
import com.zihao.GA_TS_SLAB.Solver.GurobiSchedule; // 修改为使用GurobiSchedule
...
/**
 * Description: Plot Gantt chart for a schedule solution using Gurobi Optimizer
 */
public class GanttChartPlot_Gurobi {
	public static void main(String[] args) {
		String algorithmName = "Branch and Bound"; // 修改算法名称
...
//        File parentDir = new File("src/Dataset/RNAseq/N5");
		...
		// 修改为使用GurobiSchedule替代MILPSchedule
		GurobiSchedule gurobiSolver = new GurobiSchedule();

		// 记录算法开始时间
		long startTime = System.currentTimeMillis();

		// 求解问题，获取最优调度方案
		Schedule schedule = gurobiSolver.solve();
